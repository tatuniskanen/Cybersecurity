...
This is of course Base64. When converted to text, it reveals the following message in hexadecimal:
...
When we convert this message to text once again, it reveals the following rot13-algorithm:

Guvf frperg vf whfg orgjrra hf: AVKH{rap0qvat_vf_abg_er4yyl_uvq1at_nalguvat}

When this is converted to text once again, we get the flag in plaintext.
